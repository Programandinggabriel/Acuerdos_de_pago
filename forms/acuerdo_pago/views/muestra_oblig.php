...
<section class="bg-light">
    ...
    if(mysqli_num_rows($querySelect) >= 1){
        ...
        while($arrObligs =  mysqli_fetch_array($querySelect)){
            echo "<tr>";
                echo "<td class='justify-content-center text-center w-1'>
                <button type='button' class='btn btn-outline-success' 
                onclick= window.location.href='../actions/frm_acuerdos.php?inidCliente=" . $arrObligs[0] . "&inNobligAcuerdo=". $arrObligs[1] 
                ."&inValorAcuerdo=".$arrObligs[7]."'>
                ...
                echo "<script>
                        //alerta
                        swal('Ooops', 'Ninguna obligación encontrada', 'error');
                      </script>"
                ;
            }
            ?>
