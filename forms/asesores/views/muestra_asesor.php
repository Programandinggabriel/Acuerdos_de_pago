...
<div class='p-2'>
                ...
                while($resultado = mysqli_fetch_array($consulta)){
                    echo "<tr>";
                        ...
                        echo "<td><button type='button' class='btn btn-outline-success' 
                            onclick= window.location.href='../actions/editar_asesor.php?idasesor=$resultado[0]'>
    ...
    <div class='container border border-success rounded p-2 mt-5 w-75'>
        <div class='row'>
            <div class='col-12 d-flex justify-content-center text-center'>
                <div class='col-3'>
                    <button type='button' class="btn btn-outline-success m-2 mb-3 mx-0" id='retroceso'> 
    ...
    <script src='../js/muestra_asesor.js'></script>
</body>
</html>
